    ...
    <div>
      <div className={styles.header}>
        ...
        <div className={styles.nav}>
          <a href="https://github.com/Gabrielg2d2">
            <svg
              stroke="currentColor"
              fill="currentColor"
              strokeWidth="0"
      ...
      <div className={styles.content}>
        ...
        <h4>
          Aprenda como desenvolver uma web acessível com Next.js, React.js.
        </h4>

        <p>
          Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem
          dolorem quisquam nobis nisi eveniet. Cupiditate voluptatem ex, fuga
          iusto animi dolore earum dolorem incidunt eaque, accusantium ipsam
          magni voluptates neque!
        </p>
